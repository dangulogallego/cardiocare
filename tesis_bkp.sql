...
--
-- Name: medical_categoriapregunta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_categoriapregunta OWNER TO postgres;

--
-- Name: medical_categoriapregunta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_categoriapregunta_id_seq OWNER TO postgres;

--
-- Name: medical_categoriapregunta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_examen OWNER TO postgres;

--
-- Name: medical_examen_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_examen_id_seq OWNER TO postgres;

--
-- Name: medical_examen_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_examen_respuestas OWNER TO postgres;

--
-- Name: medical_examen_respuestas_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_examen_respuestas_id_seq OWNER TO postgres;

--
-- Name: medical_examen_respuestas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_observaciones; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_observaciones OWNER TO postgres;

--
-- Name: medical_observaciones_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_observaciones_id_seq OWNER TO postgres;

--
-- Name: medical_observaciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_opcionpregunta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_opcionpregunta OWNER TO postgres;

--
-- Name: medical_opcionpregunta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_opcionpregunta_id_seq OWNER TO postgres;

--
-- Name: medical_opcionpregunta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_pregunta OWNER TO postgres;

--
-- Name: medical_pregunta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_pregunta_id_seq OWNER TO postgres;

--
-- Name: medical_pregunta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_pregunta_opciones OWNER TO postgres;

--
-- Name: medical_pregunta_opciones_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_pregunta_opciones_id_seq OWNER TO postgres;

--
-- Name: medical_pregunta_opciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_puntajecategoria; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_puntajecategoria OWNER TO postgres;

--
-- Name: medical_puntajecategoria_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_puntajecategoria_id_seq OWNER TO postgres;

--
-- Name: medical_puntajecategoria_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_respuesta OWNER TO postgres;

--
-- Name: medical_respuesta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_respuesta_id_seq OWNER TO postgres;

--
-- Name: medical_respuesta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_tipoexamen OWNER TO postgres;

--
-- Name: medical_tipoexamen_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_tipoexamen_id_seq OWNER TO postgres;

--
-- Name: medical_tipoexamen_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_tipoexamen_preguntas OWNER TO postgres;

--
-- Name: medical_tipoexamen_preguntas_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE medical_tipoexamen_preguntas_id_seq OWNER TO postgres;

--
-- Name: medical_tipoexamen_preguntas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_facultad; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_facultad OWNER TO postgres;

--
-- Name: profiling_facultad_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_facultad_id_seq OWNER TO postgres;

--
-- Name: profiling_facultad_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_habitsantecedents OWNER TO postgres;

--
-- Name: profiling_habitsantecedents_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_habitsantecedents_id_seq OWNER TO postgres;

--
-- Name: profiling_habitsantecedents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_paciente OWNER TO postgres;

--
-- Name: profiling_paciente_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_paciente_id_seq OWNER TO postgres;

--
-- Name: profiling_paciente_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_regimensalud; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_regimensalud OWNER TO postgres;

--
-- Name: profiling_regimensalud_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE profiling_regimensalud_id_seq OWNER TO postgres;

--
-- Name: profiling_regimensalud_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: medical_categoriapregunta id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_observaciones id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_opcionpregunta id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_puntajecategoria id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_facultad id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_regimensalud id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
2	pbkdf2_sha256$36000$a0bhVga3wJmO$b2LfonClH77QjB3KppOUPO3mQFwkKdi+pPSDphIrlFE=	2017-10-09 10:38:31.891385-05	f	123456789	Gerson	Yarce Franco	user@gmail.com	f	t	2017-10-09 10:13:37-05
1	pbkdf2_sha256$36000$u8wmzgLm3iVs$ubHbwvhKxAB9wY2dEPkf3OSblnh+okEOKWBrf40lt9s=	2017-10-09 17:16:09.856205-05	t	admin			admin@gmail.com	t	t	2017-09-23 15:10:30.636309-05
\.
...
76	2017-10-09 10:12:34.586126-05	3	123456789	3		10	1
77	2017-10-09 10:13:05.26408-05	2	123456779	2	[{"changed": {"fields": ["user", "cod_paciente"]}}]	10	1
78	2017-10-09 10:13:37.788864-05	2	123456789	1	[{"added": {}}]	4	1
79	2017-10-09 10:13:41.185864-05	1	123456789	2	[{"changed": {"fields": ["user"]}}]	10	1
80	2017-10-09 10:37:57.267421-05	2	123456789	2	[{"changed": {"fields": ["first_name", "last_name", "email"]}}]	4	1
81	2017-10-09 17:28:24.960426-05	2	Examen Lipdico	1	[{"added": {}}]	16	1
82	2017-10-09 17:28:35.973861-05	2	Examen Lipídico	2	[{"changed": {"fields": ["nombre"]}}]	16	1
83	2017-10-09 17:35:32.674212-05	26	Colesterol HDL	1	[{"added": {}}]	15	1
84	2017-10-09 17:35:52.955151-05	27	Triglicéridos	1	[{"added": {}}]	15	1
85	2017-10-09 17:36:17.446387-05	28	Colesterol LDL	1	[{"added": {}}]	15	1
86	2017-10-09 17:36:33.522734-05	29	Presión Arterial Sistólica	1	[{"added": {}}]	15	1
87	2017-10-09 17:36:38.305182-05	2	Examen Lipídico	2	[]	16	1
88	2017-10-10 16:36:47.187029-05	7	Test Asa - 123456789	3		13	1
89	2017-10-10 16:36:47.230302-05	6	Test Asa - 123456779	3		13	1
90	2017-10-10 16:36:47.231774-05	5	Test Asa - 123456789	3		13	1
91	2017-10-10 16:36:47.23321-05	4	Test Asa - 123456789	3		13	1
92	2017-10-10 16:36:47.234614-05	3	Test Asa - 123456789	3		13	1
93	2017-10-10 16:36:47.236027-05	2	Test Asa - 123456789	3		13	1
94	2017-10-10 16:36:47.237468-05	1	Test Asa - 123456789	3		13	1
95	2017-10-10 21:32:40.250768-05	29	Presión Arterial Sistólica	2	[{"changed": {"fields": ["slug"]}}]	15	1
96	2017-10-10 21:32:48.104292-05	28	Colesterol LDL	2	[{"changed": {"fields": ["slug"]}}]	15	1
97	2017-10-10 21:32:57.753665-05	27	Triglicéridos	2	[{"changed": {"fields": ["slug"]}}]	15	1
98	2017-10-10 21:33:04.455543-05	26	Colesterol HDL	2	[{"changed": {"fields": ["slug"]}}]	15	1
\.
...
30	profiling	0005_auto_20171009_1511	2017-10-09 10:11:31.387714-05
31	profiling	0006_auto_20171009_1512	2017-10-09 10:14:29.730277-05
32	medical	0013_examen_seguimiento	2017-10-09 11:53:10.313471-05
33	profiling	0007_auto_20171009_1959	2017-10-09 14:59:38.589174-05
34	medical	0014_auto_20171011_0228	2017-10-10 21:28:40.423829-05
35	medical	0015_pregunta_slug	2017-10-10 21:31:51.894341-05
36	medical	0016_auto_20171011_0232	2017-10-10 21:32:26.556879-05
\.
...
ha306d9l29kp63eli24s9472z4f6pl8y	NTJhYjhjMjdhZjA3NWZhZTYxZjdlMTJhMTI3MzAwN2ZhMTEyOTU4Yjp7Il9hdXRoX3VzZXJfaGFzaCI6Ijc2MzAxOWI5MTA3NjVjODMyM2U3YTAxZmZjMzNhNDQzODhmZjcwNzQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIyIn0=	2017-10-23 10:38:31.893637-05
t70kunm2m80pavd3zvopawox6bza7swo	Yjk2ZTA4ZjU4MDJkMTA4MjUwODQ3MWYzZmM2MjY4ODc4NmYyMzA0Yzp7Il9hdXRoX3VzZXJfaGFzaCI6IjYyZWI1YzdmNGE1ZmNhZDY4YzFiZmY4ZmNiYzkyMzhkMzgzMzY5ZDYiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=	2017-10-23 17:16:09.860429-05
\.


--
-- Data for Name: medical_categoriapregunta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_examen; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY medical_examen (id, fecha, paciente_id, resultado, tipo_id, seguimiento) FROM stdin;
8	2017-10-10	2	0	2	1
9	2017-10-10	2	0	2	2
10	2017-10-10	2	56	1	1
\.


--
-- Data for Name: medical_examen_respuestas; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_observaciones; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_opcionpregunta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_pregunta; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY medical_pregunta (id, texto, categoria_id, slug) FROM stdin;
13	Cuando Necesito ayuda puedo recurrir a mis amigos.	1	\N
23	Si yo no puedo cuidarme puedo buscar ayuda.	1	\N
2	Reviso si las Formas que Practico habitualmente para mantener con salud, son buenas.	2	\N
5	Yo puedo hacer lo necesario para mantener limpio el ambiente en el que vivo.	2	\N
6	Hago en primer lugar lo que sea necesario para mantenerme con Salud.	2	\N
8	Yo puedo buscar mejores formas para cuidar de mi salud que las que tengo ahora.	2	\N
9	Cambio la frecuencia en que me baño para mantenerme limpio.	2	\N
15	Cuando obtengo información sobre mi salud pido explicaciones sobre lo que no entiendo.	2	\N
16	Yo examino mi cuerpo para ver si hay algún cambio.	2	\N
17	He sido capaz de cambiar hábitos que tenia muy arraigados con tal de mejorar mi salud.	2	\N
18	Cuando tengo que tomar una nueva medicina cuento con una persona que me brinde información sobre los efectos secundarios.	\N	\N
20	Soy capaz de evaluar que tanto me sirve lo que hago para mantenerme con salud	2	\N
22	Si mi salud se ve afectada yo puedo conseguir la información necesaria sobre que hacer.	2	\N
24	Puedo sacar tiempo para mi.	2	\N
1	A medida que cambian las circunstancias yo voy haciendo ajustes para mantener mi salud.	5	\N
11	Cuando hay situaciones que me afectan yo las manejo de manera que pueda mantener mi forma de ser.	5	\N
19	Soy capaz de tomar medidas para garantizar que mi familia y yo no corramos peligro.	5	\N
25	Si presento limitaciones para movilizarme soy capaz de cuidarme como a mi me gusta.	5	\N
3	Si tengo problemas para moverme o desplazarme me las arreglo para conseguir ayuda.	3	\N
7	Me faltan las fuerzas necesarias para cuidarme como debo.	3	\N
12	Pienso en hacer ejercicio y descansar un poco durante el día pero no llego hacerlo.	3	\N
14	Pudo dormir lo suficiente  para sentirme descansado (a)	3	\N
21	Debido a mis ocupaciones diarias me resulta difícil sacar tiempo para cuidarme.	3	\N
10	Para mantener el peso que me corresponde hago cambios en mis hábitos alimenticios	4	\N
29	Presión Arterial Sistólica	\N	pas
28	Colesterol LDL	\N	ldl
27	Triglicéridos	\N	trigliceridos
26	Colesterol HDL	\N	hdl
\.


--
-- Data for Name: medical_pregunta_opciones; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_puntajecategoria; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_respuesta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_tipoexamen; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: medical_tipoexamen_preguntas; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: profiling_facultad; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: profiling_habitsantecedents; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY profiling_habitsantecedents (id, tabaquismo, diabetes, hipertension, iam, seguimiento, fecha, paciente_id) FROM stdin;
3	t	f	f	t	1	2017-10-09	2
4	t	f	f	t	2	2017-10-09	1
5	t	t	f	t	2	2017-10-09	1
6	t	f	t	t	3	2017-10-09	1
\.


--
-- Data for Name: profiling_paciente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY profiling_paciente (id, cod_paciente, fecha_nacimiento, genero, telefono, estado_civil, estrato, facultad_id, regimen_salud_id, nombre, primer_apellido, segundo_apellido, fecha_creacion, user_id) FROM stdin;
2	123456779	1992-05-12	M	3114563245	Unión Libre	3	1	1	Diego	Angulo	Perez	2017-10-09	1
1	123456789	1992-12-05	M	3168309653	Casado	4	1	1	Gerson	Yarce	Franco	2017-10-09	2
\.


--
-- Data for Name: profiling_regimensalud; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: medical_categoriapregunta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_examen_id_seq', 10, true);


--
-- Name: medical_examen_respuestas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_examen_respuestas_id_seq', 177, true);


--
-- Name: medical_observaciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_opcionpregunta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_pregunta_id_seq', 29, true);


--
-- Name: medical_pregunta_opciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_puntajecategoria_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_respuesta_id_seq', 177, true);


--
-- Name: medical_tipoexamen_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_tipoexamen_id_seq', 2, true);


--
-- Name: medical_tipoexamen_preguntas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('medical_tipoexamen_preguntas_id_seq', 29, true);


--
-- Name: profiling_facultad_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('profiling_habitsantecedents_id_seq', 6, true);


--
-- Name: profiling_paciente_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_regimensalud_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: medical_categoriapregunta medical_categoriapregunta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen medical_examen_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas medical_examen_respuestas_examen_id_respuesta_id_bfd77c9c_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas medical_examen_respuestas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_observaciones medical_observaciones_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_opcionpregunta medical_opcionpregunta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones medical_pregunta_opcione_pregunta_id_opcionpregun_8b04f7d2_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones medical_pregunta_opciones_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta medical_pregunta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_puntajecategoria medical_puntajecategoria_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta medical_respuesta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen medical_tipoexamen_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas medical_tipoexamen_pregu_tipoexamen_id_pregunta_i_a257816f_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas medical_tipoexamen_preguntas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_facultad profiling_facultad_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents profiling_habitsantecedents_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente profiling_paciente_cod_paciente_0e8772ba_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY profiling_paciente
    ADD CONSTRAINT profiling_paciente_cod_paciente_0e8772ba_uniq UNIQUE (cod_paciente);


--
-- Name: profiling_paciente profiling_paciente_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente profiling_paciente_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY profiling_paciente
    ADD CONSTRAINT profiling_paciente_user_id_key UNIQUE (user_id);


--
-- Name: profiling_regimensalud profiling_regimensalud_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_paciente_id_bc525995; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas_examen_id_d4575408; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas_respuesta_id_182a6e85; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_tipo_id_cdd90c3c; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_observaciones_categoria_id_02006cb8; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_categoria_id_c265f7c9; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones_opcionpregunta_id_a15522dc; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones_pregunta_id_42802dc8; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta_pregunta_id_8ebf10b1; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas_pregunta_id_bccf10aa; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas_tipoexamen_id_b8c0193c; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents_paciente_id_007a9739; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente_cod_paciente_0e8772ba_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX profiling_paciente_cod_paciente_0e8772ba_like ON profiling_paciente USING btree (cod_paciente varchar_pattern_ops);


--
-- Name: profiling_paciente_facultad_id_b26746a6; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente_regimen_salud_id_aecdb775; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen medical_examen_paciente_id_bc525995_fk_profiling_paciente_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas medical_examen_respu_examen_id_d4575408_fk_medical_e; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen_respuestas medical_examen_respu_respuesta_id_182a6e85_fk_medical_r; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_examen medical_examen_tipo_id_cdd90c3c_fk_medical_tipoexamen_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_observaciones medical_observacione_categoria_id_02006cb8_fk_medical_p; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta medical_pregunta_categoria_id_c265f7c9_fk_medical_c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones medical_pregunta_opc_opcionpregunta_id_a15522dc_fk_medical_o; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_pregunta_opciones medical_pregunta_opc_pregunta_id_42802dc8_fk_medical_p; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_respuesta medical_respuesta_pregunta_id_8ebf10b1_fk_medical_pregunta_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas medical_tipoexamen_p_pregunta_id_bccf10aa_fk_medical_p; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: medical_tipoexamen_preguntas medical_tipoexamen_p_tipoexamen_id_b8c0193c_fk_medical_t; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_habitsantecedents profiling_habitsante_paciente_id_007a9739_fk_profiling; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente profiling_paciente_facultad_id_b26746a6_fk_profiling; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente profiling_paciente_regimen_salud_id_aecdb775_fk_profiling; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: profiling_paciente profiling_paciente_user_id_f3cdfd3a_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY profiling_paciente
    ADD CONSTRAINT profiling_paciente_user_id_f3cdfd3a_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
